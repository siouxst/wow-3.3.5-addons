...
--if ("AutoBarButtonHearth" == tostring(buttonKey)) then
--	local popupOnModifier = self:GetHierarchicalSetting("popupOnShift")
--	local alwaysPopup = self.buttonDB.alwaysPopup
--	print("SetupButton Hearth  noPopup " .. tostring(noPopup) .. " PopupOnShift " .. tostring(popupOnModifier) .. " AlwaysPopUp " .. tostring(alwaysPopup))
--end
